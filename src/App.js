    ...
    <div className="App container mt-5">
      ...
      <div className="col-md-8 mx-auto">
        ...
        <ol className="list-group list-group-numbered mb-5">
          <li className="list-group-item">Как се признава завършен период или клас?</li>
          <li className="list-group-item">Какви заявления са необходими за издаване на удостоверение за признаване на завършен период или клас?</li>
          <li className="list-group-item">Какви заявление са необходими за издаване на дубликат на удостоверение или уверение за вече признати етапи?</li>
        </ol>
